...
public abstract class AbstractListManipulatorTest {
  ...
  public void setup() {
    ...
    list1 = new ListNode(FIVE);
    list1.next = list1;
    list1.previous = list1;
    list2 = new ListNode(FIVE);
    ListNode list2Node2 = new ListNode(THREE);
    list2.next = list2Node2;
    list2Node2.previous = list2;
    list2.previous = list2Node2;
    list2Node2.next = list2;
    list3 = new ListNode(FIVE);
    ListNode list3Node2 = new ListNode(THREE);
    ListNode list3Node3 = new ListNode(NINE);
    list3.next = list3Node2;
    list3Node2.previous = list3;
    list3Node3.previous = list3Node2;
    list3Node2.next = list3Node3;
    list3Node3.next = list3;
    list3.previous = list3Node3;
    list4 = new ListNode(FIVE);
    ListNode list4Node2 = new ListNode(THREE);
    ListNode list4Node3 = new ListNode(NINE);
    list4.next = list4Node2;
    list4Node2.previous = list4;
    list4Node3.previous = list4Node2;
    list4Node2.next = list4Node3;
    list4Node3.next = list4;
    list4.previous = list4Node3;
    list5 = new ListNode(ONE);
    ListNode list5Node2 = new ListNode(TWO);
    ListNode list5Node3 = new ListNode(THREE);
    list5.next = list5Node2;
    list5Node2.previous = list5;
    list5Node3.previous = list5Node2;
    list5Node2.next = list5Node3;
    list5Node3.next = list5;
    list5.previous = list5Node3;
    list6 = new ListNode(FIVE);
    ListNode list6Node2 = new ListNode(FIVE);
    ListNode list6Node3 = new ListNode(NINE);
    list6.next = list6Node2;
    list6Node2.previous = list6;
    list6Node3.previous = list6Node2;
    list6Node2.next = list6Node3;
    list6Node3.next = list6;
    list6.previous = list6Node3;
    list7 = new ListNode(THREE);
    ListNode list7Node2 = new ListNode(TWO);
    ListNode list7Node3 = new ListNode(ONE);
    list7.next = list7Node2;
    list7Node2.previous = list7;
    list7Node3.previous = list7Node2;
    list7Node2.next = list7Node3;
    list7Node3.next = list7;
    list7.previous = list7Node3;
    list8 = new ListNode(THREE);
    ListNode list8Node2 = new ListNode(NINE);
    list8.next = list8Node2;
    list8Node2.previous = list8;
    list8.previous = list8Node2;
    list8Node2.next = list8;
    list9 = new ListNode(NINE);
    list9.next = list9;
    list9.previous = list9;
    list10 = new ListNode(FIVE);
    list10.next = list10;
    list10.previous = list10;
    list11 = new ListNode(SIX);
    list11.next = list11;
    list11.previous = list11;
    list12 = new ListNode(SIX);
    ListNode list12Node2 = new ListNode(FOUR);
    list12.next = list12Node2;
    list12Node2.previous = list12;
    list12.previous = list12Node2;
    list12Node2.next = list12;
    list13 = new ListNode(SIX);
    ListNode list13Node2 = new ListNode(FOUR);
    ListNode list13Node3 = new ListNode(TEN);
    list13.next = list13Node2;
    list13Node2.previous = list13;
    list13Node3.previous = list13Node2;
    list13Node2.next = list13Node3;
    list13Node3.next = list13;
    list13.previous = list13Node3;
    list14 = new ListNode(THREE);
    list14.next = list14;
    list14.previous = list14;
    list15 = new ListNode(FOUR);
    ListNode list15Node2 = new ListNode(TEN);
    list15.next = list15Node2;
    list15Node2.previous = list15;
    list15.previous = list15Node2;
    list15Node2.next = list15;
    list16 = new ListNode(FIVE);
    ListNode list16Node2 = new ListNode(NINE);
    list16.next = list16Node2;
    list16Node2.previous = list16;
    list16.previous = list16Node2;
    list16Node2.next = list16;
    list17 = new ListNode(ONE);
    list17.next = list17;
    list17.previous = list17;
    list18 = new ListNode(THREE);
    ListNode list18Node2 = new ListNode(TWO);
    list18.next = list18Node2;
    list18Node2.previous = list18;
    list18.previous = list18Node2;
    list18Node2.next = list18;
